...
bool SquareBoundingBox::hasIntersect(const GameObject& one, const GameObject& other) {
...
CollisionComponent::CollisionType CollisionComponent::intersect(const SDLActor& one, const SDLActor& other) {
    auto thisSurface = one.getSurface();
